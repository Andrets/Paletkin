...
const defaultMarketplaces = [
    ...
    warehouseGroups: [
      {
        ...
        tariffs: [
          { quantity: "1 Палет", price: "4200 ₽" },
          { quantity: "2 Палет", price: "4200 ₽" },
          { quantity: "3 Палет", price: "4200 ₽" },
          { quantity: "От 9 до 10 паллет", price: "4200 ₽" },
          { quantity: "От 11 до 11 паллет", price: "4200 ₽" },
        ],
      },
      {
        label: "Склады 2",
        ...
        tariffs: [
          { quantity: "1 Палет", price: "5800 ₽" },
          { quantity: "2 Палет", price: "5500 ₽" },
          { quantity: "3 Палет", price: "5200 ₽" },
        ],
      },
    ],
  },
  {
    ...
    warehouseGroups: [
      {
        label: "Склады 1",
        warehouses: ["Хоругвино", "Пушкино", "Тверь"],
        tariffs: [
          { quantity: "1 Палет", price: "3900 ₽" },
          { quantity: "2 Палет", price: "3700 ₽" },
        ],
      },
    ],
  },
  {
    ...
    warehouseGroups: [
      {
        label: "Склады 1",
        warehouses: ["Софьино", "Томилино"],
        tariffs: [{ quantity: "1 Палет", price: "4000 ₽" }],
      },
    ],
  },
  {
    ...
    warehouseGroups: [
      {
        label: "Склады 1",
        warehouses: ["Быково"],
        tariffs: [{ quantity: "1 Палет", price: "4500 ₽" }],
      },
    ],
  },
  {
    ...
    warehouseGroups: [
      {
        label: "Склады 1",
        warehouses: ["Котовск"],
        tariffs: [{ quantity: "1 Палет", price: "4100 ₽" }],
      },
    ],
  },
  {
    ...
    warehouseGroups: [
      {
        label: "Склады 1",
        warehouses: ["Краснодар"],
        tariffs: [{ quantity: "1 Палет", price: "3800 ₽" }],
      },
    ],
  },
  {
    ...
    warehouseGroups: [
      {
        label: "Склады 1",
        warehouses: ["Софьино"],
        tariffs: [{ quantity: "1 Палет", price: "4300 ₽" }],
      },
    ],
  },
];
...
export default function TariffsSection({
  ...
  const activeMarketplace =
    marketplaces.find((m) => m.id === activeMarketplaceId) ?? marketplaces[0];
      ...
      <div className="tariff-section-data">
            ...
            >
              ...
              <ul className="tariff-section-warehouses-tags">
                {group.warehouses.map((wh, j) => (
                  <li
                    key={j}
                    className="tariff-section-warehouse-tag marketplace-tag"
                  >
                    {wh}
                  </li>
                ))}
        ...
        <div className="tariff-section-prices-block">
          <div className="tariff-section-prices-header">
            <span className="tariff-section-prices-col-title">
              Количество паллет
            </span>
            ...
            <ul className="tariff-section-prices-list">
              {currentGroup.tariffs.map((row, i) => (
                <li key={i} className="tariff-section-price-row">
                  <span className="tariff-section-price-quantity">
                    {row.quantity}
                  </span>
                  <span className="tariff-section-price-pill">
                    <span className="marketplace-tag">{row.price}</span>
                  </span>
                </li>
              ))}
            </ul>
