...
function Map2GIS({
  ...
  useEffect(() => {
    ...
    if (!key) {
      console.warn(
        "VITE_2GIS_MAP_KEY не задан — добавьте в .env. Карта 2GIS не загружена.",
      );
      return;
    }
    ...
    const initMap = async () => {
      try {
        ...
        if (
          ...
          if (!adapter) {
            console.warn(
              "WebGPU adapter недоступен. Карта 2GIS пропущена для этой среды.",
            );
            return;
          }
        }
...
export default function CalculatorComponent({ mode = "estimate" }) {
  ...
  const mapContainerIdRef = useRef(
    "calc-map-2gis-" + Math.random().toString(36).slice(2),
  );
  const markerIcons = {
  ...
  useEffect(() => {
    ...
    const handler = (e) => {
      const activeRef =
        dateModalField === "pickup"
          ? pickupDateFieldRef.current
          : deliveryDateFieldRef.current;
      ...
      <div className="calc-form-wrapper">
        <div className="form-header">
          <h2>
            Расчёт стоимости
            <br />
            доставки на маркетплейсы
          </h2>
          <p>
            Укажите адреса погрузки и выгрузки, укажите параметры и получите
        ...
        <div className="address-block">
          <div className="address-requared">
            ...
            <button className="address-switch" type="button">
              ...
              <span className="address-btn-label address-btn-switch">
                Поменять местами
              </span>
            </button>
        ...
        {mode === "checkout" && (
          <div className="main-info">
            <h4 className="info-title">Основная информация *</h4>
                      ...
                      <div className="modal-time">
                        ...
                        <div className="time-inputs">
                          ...
                          <input
                            ...
                            min="0"
                            max="59"
                            value={String(tempDate.getMinutes()).padStart(
                              2,
                              "0",
                            )}
                            onChange={(e) =>
              ...
              <div className="date-field" ref={deliveryDateFieldRef}>
                ...
                <div className="quick-dates">
                  ...
                  <button
                    type="button"
                    className={
                      deliveryQuickPreset === "tomorrow" ? "active" : ""
                    }
                    onClick={() => {
                      const d = new Date();
                      d.setDate(d.getDate() + 1);
          ...
          {cargoType === "Сборный груз" && (
            <div className="calc-animate-in">
                ...
                {palletOptions.map((opt) => (
                  ...
                  >
                    ...
                    <div className="pallet-card-text">
                      ...
                      <div className="pallet-dims">x{opt.dims}</div>
                      <div className="pallet-coeff">x {opt.factor}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="cargo-info">
                <input
                  className="field-input cargo-input"
                ...
                >
                  {vehicles.map((v, idx) => (
                    <button
                      ...
                      data-index={idx}
                      ref={(el) => {
                        vehicleCardRefs.current[idx] = el;
                      }}
        ...
        <div className="services">
          ...
          <div className="service-buttons">
            ...
            <button
              ...
              onClick={() => setServices((s) => ({ ...s, return: !s.return }))}
            >
              Возврат ∙ 50% от км
        ...
        <div className="calculator-cta-block">
          <div className="calculator-cta-left">
            <label className="calculator-cta-toggle">
              ...
              <span className="calculator-cta-toggle-label">
                Бизнес доставка
              </span>
            </label>
